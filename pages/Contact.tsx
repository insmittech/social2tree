                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                            ...
                            <div className="space-y-8 mb-16">
                                {[
                                    ...
                                    <div key={i} className="flex items-start gap-5">
                                        <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#05080f] border border-teal-500/20 shadow-[inset_0_0_15px_rgba(20,184,166,0.1)] flex items-center justify-center text-teal-400">
                                            {item.icon}
                                        </div>
                                        <div>
                        ...
                        <div className="relative w-full max-w-lg mx-auto lg:max-w-none">
                            ...
                            <div className="bg-slate-900/40 backdrop-blur-2xl border border-slate-800 rounded-[2.5rem] p-8 sm:p-10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_20px_40px_-10px_rgba(0,0,0,0.5)]">
                                ...
                                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                type="text"
                                                placeholder="John"
                                                className="w-full bg-[#05080f]/80 border border-slate-700/60 focus:border-teal-500 rounded-xl px-4 py-3.5 text-slate-200 placeholder-slate-600 outline-none focus:ring-1 focus:ring-teal-500 transition-all shadow-inner"
                                            />
                                        </div>
                                        <div className="space-y-2">
                                        ...
                                        <div className="space-y-2 relative">
                                            ...
                                            <div className="relative flex items-center">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-[#05080f]/80 border border-slate-700/60 focus:border-teal-500 rounded-xl pl-12 pr-4 py-3.5 text-slate-200 placeholder-slate-600 outline-none focus:ring-1 focus:ring-teal-500 transition-all shadow-inner"
                                                />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-1">Organization Name</label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="space-y-2 relative">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-1">Team Size</label>
                                            <select className="w-full appearance-none bg-[#05080f]/80 border border-slate-700/60 focus:border-teal-500 rounded-xl px-4 py-3.5 text-slate-200 outline-none focus:ring-1 focus:ring-teal-500 transition-all shadow-inner">
                                                <option value="" disabled selected hidden className="text-slate-600">Select Size</option>
                                         ...
                                         <div className="space-y-2 relative">
                                            ...
                                            <select className="w-full appearance-none bg-[#05080f]/80 border border-slate-700/60 focus:border-teal-500 rounded-xl px-4 py-3.5 text-slate-200 outline-none focus:ring-1 focus:ring-teal-500 transition-all shadow-inner">
                                                <option value="" disabled selected hidden className="text-slate-600">Select Role</option>
                                    ...
                                    {/* Company Type Row */}
                                    <div className="space-y-2 relative">
                                        <label className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-1">Company Type</label>
                                        <select className="w-full appearance-none bg-[#05080f]/80 border border-slate-700/60 focus:border-teal-500 rounded-xl px-4 py-3.5 text-slate-200 outline-none focus:ring-1 focus:ring-teal-500 transition-all shadow-inner">
                                            <option value="" disabled selected hidden className="text-slate-600">Select Industry / Type</option>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-[#05080f]/80 border border-slate-700/60 focus:border-teal-500 rounded-xl px-4 py-4 text-slate-200 placeholder-slate-600 outline-none focus:ring-1 focus:ring-teal-500 transition-all shadow-inner resize-none"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3 pt-2">
                                        <div className="relative flex items-center mt-1">
                                            <input type="checkbox" id="privacy" className="peer w-5 h-5 appearance-none rounded border border-slate-600 bg-[#05080f] checked:bg-teal-500 checked:border-teal-500 cursor-pointer transition-colors" />
                                            <svg className="absolute w-3 h-3 text-[length:0] text-[#05080f] pointer-events-none top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 peer-checked:text-[length:12px] opacity-0 peer-checked:opacity-100 transition-opacity" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 5L4.5 8.5L13 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                        </div>
                                        <label htmlFor="privacy" className="text-sm text-slate-400 leading-relaxed cursor-pointer select-none">
                                            I agree to the <span className="text-teal-400 hover:text-teal-300 transition-colors">Terms of Service</span> and <span className="text-teal-400 hover:text-teal-300 transition-colors">Privacy Policy</span>.
                                        </label>
                                    </div>
