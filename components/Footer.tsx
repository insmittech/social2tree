...
const Footer: React.FC<FooterProps> = () => {
    ...
    return (
        <footer className="bg-slate-50 dark:bg-[#05080f] border-t border-slate-200 dark:border-teal-900/30 pt-24 pb-12 overflow-hidden relative selection:bg-teal-500/30 transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20 lg:pr-64">
                    ...
                    {/* Col 1: Products */}
                    <div>
                        <h4 className="text-slate-900 dark:text-white font-bold text-sm tracking-[0.2em] uppercase mb-8 transition-colors">Products</h4>
                        <ul className="space-y-4">
                            {productsLinks.map((link, idx) => (
                                <li key={idx}>
                                    <Link to={link.to} className="text-slate-600 dark:text-slate-400 text-[15px] font-medium hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-300 flex items-center gap-1 group">
                    ...
                    {/* Col 2: Resources */}
                    <div>
                        <h4 className="text-slate-900 dark:text-white font-bold text-sm tracking-[0.2em] uppercase mb-8 transition-colors">Resources</h4>
                        <ul className="space-y-4">
                    ...
                    {/* Col 3: Company */}
                    <div>
                        <h4 className="text-slate-900 dark:text-white font-bold text-sm tracking-[0.2em] uppercase mb-8 transition-colors">Company</h4>
                        <ul className="space-y-4">
                    ...
                    {/* Col 4: Contacts Info */}
                    <div>
                        <h4 className="text-slate-900 dark:text-white font-bold text-sm tracking-[0.2em] uppercase mb-8 transition-colors">Contacts</h4>
                        <ul className="space-y-6">
                            <li>
                                <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 transition-colors">PR</p>
                ...
                <div className="lg:absolute lg:top-24 lg:right-6 lg:w-48 flex flex-col items-start lg:items-end md:items-center mt-12 lg:mt-0 pt-12 border-t border-slate-200 dark:border-slate-800 lg:border-t-0 lg:pt-0 transition-colors">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://twitter.com/sociallinks" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white text-black flex items-center justify-center hover:scale-110 shadow-md hover:shadow-xl dark:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-300 group">
                            <Twitter size={20} fill="currentColor" className="group-hover:text-teal-600 transition-colors" />
                        </a>
                        <a href="https://linkedin.com/company/sociallinks" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white text-black flex items-center justify-center hover:scale-110 shadow-md hover:shadow-xl dark:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-300 group">
                            <Linkedin size={20} fill="currentColor" className="group-hover:text-cyan-600 transition-colors" />
                        </a>
                        <a href="https://youtube.com/sociallinks" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white text-black flex items-center justify-center hover:scale-110 shadow-md hover:shadow-xl dark:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-300 group">
                ...
                <div className="mt-16 pt-8 border-t border-slate-200 dark:border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-6 transition-colors">
                     <div className="flex items-center gap-2">
                        <div className="bg-teal-500/10 dark:bg-teal-500/20 p-1.5 rounded-lg border border-teal-500/20 dark:border-teal-500/30 transition-colors">
                            <Shield className="text-teal-500 dark:text-teal-400 w-4 h-4 transition-colors" />
                        </div>
                        <span className="text-sm font-bold text-slate-900 dark:text-white tracking-widest transition-colors">Social<span className="text-teal-500 dark:text-teal-400">2Tree</span></span>
                    </div>
